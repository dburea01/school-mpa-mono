...
<div class="col-md-9 mt-3 mt-md-0">
    ...
    <div class="card shadow">
        <div class="card-header text-center">
            ...
            <a href="{{ route('assignments.create', ['classroom' => $classroom ]) }}">Créer affectation</a>
            @endcan
        </div>
        <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <i class="bi bi-trash btn-delete-assignment text-danger"
                                ...
                                data-classroom-name="{{ $classroom->short_name }}"
                                data-classroom-id="{{ $classroom->id }}"
                                title="Retirer {{ $assignment->last_name.' '.$assignment->first_name }} de la classe {{ $classroom->short_name }}">
                            </i>

                            @endcan
                            @can('update', $assignment->id)
                            <a href="{{ route('assignments.edit', ['classroom' => $classroom, 'assignment' => $assignment->id ]) }}">
